            ...
            <div class="box-body">
              ...
              <div class="tab-content">
                <div id="input" class="tab-pane fade in active">
                  ...
                  {
                    $id_user = $_GET['id'];
                    $datalist = mysqli_query($koneksi,"select * from user ");
                  ...
                  ?>
                    <form action="proses_ubah_password.php" method="post" >
                      ...
                      <a href="ubah_password.php.php" class="btn btn-default" style="float: right; margin-left: 10px;"> Batal </a>
                ...
                <div id="user" class="tab-pane fade">
                  <table id="table_news" class="table table-bordered table-striped" width="100%">
                    ...
                    while($datauser = mysqli_fetch_array($data))
                    {
                      ...
                      while($ini=mysqli_fetch_array($sql))
                      {
                    ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li>
                                <a href="ubah_password.php?id=<?php echo $ini['id']; ?>">Edit</a>
                              </li>
                            </ul>
                            </div>
                          </td>
