...
<section class="isi-TIP">
 ...
 $sql=mysqli_query($koneksi,"select * from syarat");
 while($row=mysqli_fetch_array($sql))
 {
  $judul=$row['judul_syarat'];
  $isi=$row['deskripsi'];
  $gambar=$row['gambar'];
 ?>
      ...
      <div class="pict-info">
          <div class="row justify-content-md-center">
              <div class="col-md-12">
                  <img src="admin/syarat/<?php echo $gambar; ?>" alt="gambar" style="width:100%">
              </div>
          </div>  
         </div>      
